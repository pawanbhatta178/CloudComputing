...
public class sumOfCubes {
    ...
    public static void main(String args[]) throws Exception {
        ...
        FileInputFormat.setInputPaths(conf, new Path(args[0])); // n numbers is located in the file
        FileOutputFormat.setOutputPath(conf, new Path(args[1])); // we get back the sum of cubes in this output file
